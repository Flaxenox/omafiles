...
- Undo (`Ctrl+Z`) for rename, new folder, new file, make link, delete, move, bulk rename, and chmod (chmod undo restores each selected item's own previous mode, not its contents' if applied recursively).
