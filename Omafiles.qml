...
Item {
  ...
  function refresh() { navController.refresh() }
  function startDirWatch(path) { navController.startDirWatch(path) }
  function stopDirWatch() { navController.stopDirWatch() }
  ...
  function navigateTo(path) { navController.navigateTo(path) }
  function _goToPath(path) { navController._goToPath(path) }
  function navBack() { navController.navBack() }
  function navForward() { navController.navForward() }
  function openWithDefault(path) { navController.openWithDefault(path) }
  function enter(entry) { navController.enter(entry) }
  function goUp() { navController.goUp() }
