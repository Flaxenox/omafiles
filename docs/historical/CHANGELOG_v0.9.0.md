...
OmaFiles v0.9.0 marks the first official release of the standalone Qt6 generation of OmaFiles.
...
OmaFiles **v0.9.0** represents the first stable release of our standalone generation. We invite Linux users, packagers, and developers to test this release, report issues, and provide feedback on our GitHub repository.
